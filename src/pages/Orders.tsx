  ...
  return (
    ...
    >
      ...
      <div className="p-3 text-center">
        ...
        <p className="text-primary font-bold text-xl mt-1">{product.price} DH</p>
      </div>
    </div>
  );
};
    ...
    <Card className="h-full flex flex-col">
      ...
      <CardFooter className="flex flex-col p-4 border-t space-y-3">
        <div className="flex justify-between w-full text-2xl font-bold">
          <span>الإجمالي:</span>
          <span>{currentOrder.totalAmount.toFixed(2)} DH</span>
        </div>
...
const Orders = () => {
  ...
  return (
    <>
      ...
      {/* We rely on the .print-only class in globals.css to hide it in screen view */}
      {currentOrder && (
        <div className="print-container print-only" ref={printRef}>
